...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, shs = None, colors_precomp = None, language_feature_precomp = None, language_feature_weights_quick = None, language_feature_indices = None, scales = None, rotations = None, cov3D_precomp = None):
